...
class InteractBetweenElems(object):
    def __init__(self):
        ...
        self.mvp_inner2 = numpy.zeros(mvp_inner2_tmp.shape, 'i4', order='F')
        self.mvp_inner3 = numpy.zeros(mvp_inner3_tmp.shape, 'i4', order='F')
        self.mvp_inner4 = numpy.zeros(mvp_inner4_tmp.shape, 'i4', order='F')

        self.mvp_inner2[:] = mvp_inner2_tmp[:]
        self.mvp_inner3[:] = mvp_inner3_tmp[:]
        self.mvp_inner4[:] = mvp_inner4_tmp[:]
    ...
    def interact_between_elems_inner(self, var):
        ...
        interact_inner_f90(mvp_inner2, mvp_inner3, mvp_inner4, var)
...
if __name__ == '__main__':
    ...
    numpy.save('./preprocess_files/psi.npy', state.psi)

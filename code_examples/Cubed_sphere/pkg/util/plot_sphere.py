...
from pkg.convert_coord.cs_ll import xyp2latlon, abp2latlon
from pkg.util.greatcircle import GreatCircle
from pkg.util.circumcircle import Circumcircle
...
def plot():
    ps = PlotSphere(38, 127.5, figsize=(15,15))     # Korea centered

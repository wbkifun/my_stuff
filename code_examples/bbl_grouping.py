...
# 2013.10.8     update database
# 2013.12.3     update database
# 2014.2.6      update database
#------------------------------------------------------------------------------
...
position_groups = [ \
        ['김태균', '설경희', '이주원', '강정윤', '이상훈', '진선화'], \
        ['이은희', '조경미', '전혜연', '최현주', '이준석', '장동일'], \
        ['배수야', '최인진', '김소영', '한지영'], \
        ['이아름이', '김민영', '박지현', '구은성', '박현민', '이광엽', \
         '정기섭', '김민희', '한유진', '최이태', '최정민', '김재헌'], \
        ['최석진', '남현', '강신후', '김정한', '박자린', '윤선희'], \
        ['권인혁', '주동찬', '이영수', '전상윤', '김기환'], \
        ['백지욱', '손호진', '정래윤', '엄미진'], \
        ['강전호', '권하택', '이시혜'], \
        ['하지현', '김주혜', '전형욱', '조영순', '강지순', '권지혜'], \
        ['정병주', '하수진', '채정효', '한현준', '임주연'] ]
...
previous_groupss = [ \
        ...
        [['하수진', '권인혁', '박현민', '이은희', '김윤항', '이아름이', '채정효'], \
         ['강전호', '김태균', '최이태', '엄미진', '김민희', '권하택', '한지영'], \
         ['김민영', '김주혜', '강정윤', '배수야', '이태형', '김재헌', '최석진'], \
         ['설경희', '임주연', '정기섭', '최현주', '박자린', '이광엽', '정병주'], \
         ['주동찬', '이준석', '고연정', '전형욱', '정길란', '강지순', '진경',  '하지현'], \
         ['한유진', '이시혜', '진선화', '남현',   '장동일', '백지욱', '김정한'], \
         ['강신후', '이주원', '최정민', '박지현', '전혜연', '이영수', '김소영'], \
         ['조경미', '손호진', '송효종', '이상훈', '조영순', '윤선희', '구은성'], \
         ['권지혜', '정래윤', '전상윤', '최인진', '김상일', '박종임'] \
        ], \
        [['김정한', '이은희', '구은성', '김상일', '이주원', '정래윤', '김주혜'], \
         ['김태균', '조영순', '정기섭', '배수야', '강신후', '박종임', '진경'], \
         ['백지욱', '최석진', '이광엽', '최인진', '윤선희', '박지현', '한지영'], \
         ['이시혜', '이아름이', '이영수', '설경희', '이태형', '이준석'], \
         ['채정효', '김소영', '남현', '엄미진', '정병주', '최정민'], \
         ['최이태', '전상윤', '하수진', '장동일', '임주연', '진선화'], \
         ['송효종', '김민희', '강정윤', '권인혁', '조경미', '박현민'], \
         ['최현주', '김윤항', '하지현', '강문필', '강전호', '박자린'], \
         ['권하택', '이상훈', '김재헌', '전혜연', '정길란', '한유진'] \
        ], \
        [['설경희', '김상일', '최이태', '강문필', '김재헌', '조경미', '진경'], \
         ['강전호', '박지현', '이은희', '장동일', '정병주', '구은성', '강정윤'], \
         ['임주연', '김정한', '정길란', '권인혁', '한유진', '채정효'], \
         ['하수진', '이주원', '이광엽', '남현', '이준석', '송효종'], \
         ['이태형', '정기섭', '백지욱', '김민희', '전혜연', '권하택'], \
         ['이시혜', '이상훈', '최정민', '최인진', '강신후', '최현주'], \
         ['이영수', '배수야', '하지현', '정래윤', '박현민', '진선화'], \
         ['김태균', '김주혜', '이아름이', '김소영', '김윤항', '최석진'] \
        ] ]
...
couple_groups = [['정병주', '김주혜'], ['김상일', '박지현'], ['최석진', '하지현']]

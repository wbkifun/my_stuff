...
for tn in range(1,tmax+1):
	...
	update(np.int32(nx), np.int32(ny), c_gpu, f_gpu, g_gpu, block=(256,1,1), grid=(nx*ny/256+1,1), shared=(256+2)*4)
	update(np.int32(nx), np.int32(ny), c_gpu, g_gpu, f_gpu, block=(256,1,1), grid=(nx*ny/256+1,1), shared=(256+2)*4)

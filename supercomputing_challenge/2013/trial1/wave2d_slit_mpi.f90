...
PROGRAM wave2d
  ...
  INTEGER, PARAMETER :: slit_y0=ny/2, distance=600
  INTEGER, PARAMETER :: src_y0 = slit_y0-distance
  INTEGER, PARAMETER :: tmax=2400
  !INTEGER, PARAMETER :: x0=2*nx/3, width=10, thick=5, gap=100   ! slit
  INTEGER, PARAMETER :: width=100, thick=40, gap=1000   ! slit

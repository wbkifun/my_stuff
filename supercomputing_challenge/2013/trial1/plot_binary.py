...
if __name__ == '__main__':
    ...
    #pst.plot_double_slit(x0=2*nx/3, width=10, depth=5, gap=100)
    #pst.plot_double_slit(x0=nx/2, width=40, depth=20, gap=400)
    pst.plot_double_slit(x0=nx/2, width=100, depth=50, gap=1000)

    #pst.plot_field(vmin=-0.1, vmax=0.1)     # for circular wave
    #pst.plot_field()                        # for line wave
    pst.plot_field(vmin=-0.1, vmax=0.1)     # for slit
